...
# NOTE: additional sentence boundary sentinels are added.
# Also word stemming from nltk are added by cheetah90
...
def stem_phrase_list(phrase_list):
    ...
    for phrase in phrase_list:
        ...
        stemmed_phrase_list.append(" ".join(stemmed_tokens))
...
class Rake(object):
    ...
    def run(self, text):
        ...
        #Allen added this
        phrase_list = stem_phrase_list(phrase_list)
